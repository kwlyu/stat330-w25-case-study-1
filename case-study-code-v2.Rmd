...
nurse_infl2 <- hlm_influence(final_model, level = "snum", approx = FALSE, # includes RVC
...
nurse_filtered <- nurse_filtered %>%
  mutate(fit_cond = predict(final_model), # predicted means with RE
         fit_marg = predict(final_model, re.form = NA)) # predicted means without RE
